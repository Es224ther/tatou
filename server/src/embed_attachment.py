...
from watermarking_method import WatermarkingMethod, PdfSource, SecretNotFoundError, InvalidKeyError, WatermarkingError, load_pdf_bytes
...
class EmbedAttachment(WatermarkingMethod):
	...
	def read_secret(self, pdf: PdfSource, key: str) -> str:
		...
		with pikepdf.open(io.BytesIO(data)) as pdf_obj:
			...
			payload_bytes = pdf_obj.attachments[filename]
